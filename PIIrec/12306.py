...
irreplaceFileName=dir+"12306_unmatch-v2.0.csv"
...
if __name__=="__main__":
    ...
    for i,PII in enumerate(PIIs):
        ...
        password_substring=[[origin_passwords[i][begin:begin + x + 1],begin] for x in range(2,len(temp)) for begin in range(len(temp) - x)]
        ...
        for substring in password_substring:
            index=['']
            typelist=['E','N','I','U','P','B']
            typelist2=['email','name','id','username','phone','birth']
            for j in range(3,5):
